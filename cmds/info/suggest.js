...
export default {
  ...
  run: async ({ msg, sock, args, command, text, usedPrefix: prefix }) => {
    ...
    try {
      ...
      const pp = await sock.profilePictureUrl(msg.sender, 'image').catch(() => 'https://h.uguu.se/PMBnVUgn.jpg')
      ...
      try {
        await global.sock.reply(`${global.owner[0]}@s.whatsapp.net`, reportMsg, msg)
      } catch {
        try {
