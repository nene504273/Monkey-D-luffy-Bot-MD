    ...
    try {
      ...
      const stickerResults = await Promise.all(selected.map(async (buffer) => {
        try {
          ...
          const json = { 'sticker-pack-id': 'https://github.com/nene504273/Monkey-D-luffy-Bot-MD', 'sticker-pack-name': stickerPackname, 'sticker-pack-publisher': stickerAuthor, emojis: ['🎭'] };
