...
const CODES_API_ENDPOINT = 'http://report-bots-causas.duckdns.org:3000/api/verification/codes/pending/luffy'; 
const CODES_NOTIFICATION_BASE_URL = 'http://report-bots-causas.duckdns.org:3000/api/verification/codes/mandado/luffy'; 

// Endpoints para Mensajes del Bot (Actualizaciones de Reportes)
const MESSAGES_API_ENDPOINT = 'http://report-bots-causas.duckdns.org:3000/api/verification/messages/pending/luffy';
const MESSAGES_NOTIFICATION_BASE_URL = 'http://report-bots-causas.duckdns.org:3000/api/verification/messages/mandado/luffy';
