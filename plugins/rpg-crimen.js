  ...
  switch (randomOption) {
    ...
    case 1: {
      ...
      if (amountSubtracted <= 0) {
        m.reply(`${emoji2} No fuiste cuidadoso y te atraparon, pero como no tenías ${moneda} no perdiste nada.`)
        return
      }
    ...
    case 2: {
      ...
      if (smallAmountTaken <= 0) {
        m.reply(`${emoji2} La víctima no tenía suficiente dinero, no pudiste robar nada.`)
        return
      }
