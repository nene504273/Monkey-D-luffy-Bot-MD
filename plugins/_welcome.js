...
export async function before(m, { conn, participants, groupMetadata }) {
  ...
  let frasesLuffy = [
    ...
    "¡No me rendiré nunca! 💪",
    "¡La amistad es lo más importante! ❤️",
    "¡Vamos a encontrar el One Piece! 🏴‍☠️",
  ...
  if (chat.welcome) {
    if (m.messageStubType === WAMessageStubType.GROUP_PARTICIPANT_ADD) {
      ...
      if (!profilePicture) profilePicture = 'https:                                            
      let bienvenida = ` 
🎊 ━━━─────━━━─── ¡BIENVENIDO A BORDO! 🎊 ━━━─────━━━───
...
`.trim();
      await conn.sendMessage(m.chat, { 
        image: { url: '//via.placeholder.com/100x100?text=No+Foto';
      let bienvenida = ` 
🎊 ━━━─────━━━─── ¡BIENVENIDO A BORDO! 🎊 ━━━─────━━━───
${taguser} se ha unido al grupo: ${groupMetadata.subject} 🤝
Miembros: ${totalMembers + 1} 👥
...
`.trim();
      await conn.sendMessage(m.chat, { 
        image: { url: 'https://qu.ax/aFAdU.jpg' }, 
        caption: despedida, 
        mentions: [who]