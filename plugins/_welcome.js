...
// --- PLANTILLAS DE MENSAJE PERSONALIZADAS (Estilo Luffy con cuadro) ---
...
@user
( ✨ ¡Disfruta tu estadía en el barco! ⚓ .- - - .- ' .
`;

// Plantilla para la información del grupo
export const GROUP_INFO_MESSAGE = (date, size, desc) => `
...
            // Reemplazo de los símbolos específicos de la plantilla por el tag del usuario
            .replace(/\\\$/g, userTag);
    };
...
        // Usamos chatConfig.customWelcome si existe, si no, el nuevo default.
        const welcomeMessage = chatConfig.customWelcome || DEFAULT_WELCOME_MESSAGE;
...
        const byeMessage = chatConfig.customBye || DEFAULT_GOODBYE_MESSAGE;
