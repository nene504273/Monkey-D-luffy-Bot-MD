...
let handler = async (m, { conn, usedPrefix }) => {
    ...
    /* . ╓᷼─ໍ۪┅֟፝─̥࣪:¨᜔⠣۟⠜¨᜔:࣪─࣮࣪͡┅ꊥ᜔۫☠️ꊥ᜔┅࣮࣪͡─:࣪¨᜔⠣۟⠜¨᜔:࣪─̥፝֟┅۪─᷼ໍ╖ */
/* 𓂂ฺ✦〫ᜒ⫾߲̤ᜒ☁️〫ᜒฺ߲✿ฺ𑁯〫ᜒ۪𑁯ᜒฺ `🄲᮫〪̥〫ᷭ𝆬۟𝕠𝕟𝕥𝕖𝕩𝕥᮫〪̥〫ᷭ𝆬۟ 𝕀𝕟𝕗𝕠᮫〪̥〫ᷭ𝆬۟` ╾ฺׁ⟡߲ᜒฺ⚓ᜒ𝝸᜔ׁ〫⌒ᜒฺ߲⸙ᦃᦃᜒ */
...
/* . ╙᷼─ໍ۪┅֟፝─̥࣪:¨᜔⠣۟⠜¨᜔:࣪─࣮࣪͡┅ꊥ᜔۫🍖ꊥ᜔┅࣮࣪͡─:࣪¨᜔⠣۟⠜¨᜔:࣪─̥፝֟┅۪─᷼ໍ╜ */
/* ⎯꯭⎯⵿ׄ⎯꯭⎯꯭۟⎯ ☀️ ⎯꯭⎯꯭ׄ⎯⵿⎯꯭⎯۟ */
